  ...
  <div class="navbar navbar-unm">
         ...
         <div id="upper">
           <div class="container">
            ...
            <br />
            <div class="jumbotron">
            <h2 > Crowd Learning Application Entry</h2>

   <br />
   <br />
<div class="container">
    <div class="row">
        <form role="form" action ="/crowdcs/imgRecognition.jsp">
            <div class="col-lg-6">
                <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Required Field</strong></div>
             
                <div class="form-group">
                    <label for="InputEmail">APPLICATION NAME</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="InputEmailSecond" name="InputEmail" placeholder="name" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                 <div class="form-group">
                    <label for="phone">APPLICATION URL</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="phone" name="phone" placeholder="url" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                <div class="form-group">
                    <label for="Device Type">REST API URL FOR PASSWORD UPDATE</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="dType" name="DeviceType" placeholder="url" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                 <div class="form-group">
                    <label for="InputEmail">REST API URL FOR STUDENT PERFORMANCE</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="deviceconfig" name="deviceconfig" placeholder="url" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
