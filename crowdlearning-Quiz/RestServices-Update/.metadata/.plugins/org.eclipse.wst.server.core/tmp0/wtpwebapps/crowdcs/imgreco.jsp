  ...
  <div class="navbar navbar-unm">
         ...
         <div id="upper">
           <div class="container">
            ...
            <br />
            <div class="jumbotron">
            <h2 > List of Crowd Learning Application Based on your Credit Score</h2>

   <br /><li> <a href="/crowdcs/DataDownload.jsp">Geographic Learning</li>
   <br />

<a href="/crowdcs/home.jsp">Home
   <div>
