...
<html lang="en">
  ...
  <div class="navbar navbar-unm">
   ...
   <br /><H3>IDENTIFY THE SCIENTIFIC IMAGES- 24 HRS TASK</H3>
   <BR />
   
   Identify the Images and Upload the Correct Results in the Prescribed CSV Format<br/><BR/>
   <li> <a href="/crowdcs/DataDownload.jsp"  download="imgdata/sciImages.zip" >DOWNLOAD DATA HERE</li><BR />
   <li> <a href="/crowdcs/DataDownload.jsp" download="img/scifi.csv">CSV SUBMISSION FILE</a></li><br />
   
   
   <br />
   <br />
   <form role="form" method="get" action ="/crowdcs/User.jsp">
            <div class="col-lg-6">
                <input type="submit" name="Accept" id="submit" value="Accept" class="btn btn-left btn-primary btn-block">
                   <br /><input type="text" id="downloadTime1" name="downloadTime" value="<%= new java.util.Date() %>" class="field left" readonly>
