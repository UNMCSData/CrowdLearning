  ...
  <div class="navbar navbar-unm">
         ...
         <div id="upper">
           <div class="container">
            ...
            <br />
            <div class="jumbotron">
            <h2 > UNM- Crowd Learning</h2>

   <br />CROWD LEARNING
   <br />
This Prototype contribution has the potential to advance scientific discovery while promoting
teaching, training, and learning. In particular, simple physics and chemistry crowdsourcing tasks will be
released to high schools as games and as educational exercises for students. It is expected that by interacting
with these problems, young students will be drawn to STEM fields.

    <div class="container">

      <form class="form-signin" action="/crowdcs/imgreco.jsp">
        <h2 class="form-signin-heading">Please sign in</h2>
        <div class="radio">
  <label><input type="radio" name="optradio">Users</label>
</div>
<div class="radio">
  <label><input type="radio" name="optradio">Host</label>
</div>
        ...
        <a href="/crowdcs/register.jsp">New Member Wanna CrowdSource ..Join Us!!!</a>
      </form>
