        ...
        <form role="form" action ="/crowdcs/imgRecognition.jsp">
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="InputEmailSecond" name="InputEmail" placeholder="Confirm Email" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="dType" name="DeviceType" placeholder="Laptop or Deskstop or SuperComputer" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                 <div class="form-group">
                    <label for="InputEmail">Device Config(Please give in Specified Format-Processor,RAM,HardDrive,OS)</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="deviceconfig" name="deviceconfig" placeholder="Processor,RAM,HardDrive,OS" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
