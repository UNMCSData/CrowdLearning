...
<html lang="en">
 ...
 <%@ page import="org.apache.commons.lang.time.*" %>
  ...
  <div class="navbar navbar-unm">
   ...
   <br /><H3>My List Of Works</H3>
   <BR />
IMAGE RECOGNITION APP :<% String time=request.getParameter("downloadTime"); out.print("Image Recognition Task "+time); %> &nbsp&nbsp Submit by : Tuesday Dec 08 13:55:28 <br /><br />

IMAGE RECOGNITION APP : Monday  Dec 07 09:55:28 &nbsp&nbsp Submit by : Tuesday Dec 08 10:55:28 <br /><br />

IMAGE RECOGNITION APP : Monday  Dec 07 09:57:28  &nbsp&nbsp Submit by : Tuesday Dec 08 10:55:28 <br /><br />
   
IMAGE RECOGNITION APP : Monday  Dec 07 09:55:28 &nbsp&nbsp Submit by : Tuesday Dec 08 10:55:28 <br /><br />

<form role="form" method="get" action ="/crowdcs/score.jsp">
        <br/>   
...
<br/>
<br/>
 <input type="submit" name="Submit" id="submit" value="submit" class="btn btn-left btn-primary btn-block">
        </form>
